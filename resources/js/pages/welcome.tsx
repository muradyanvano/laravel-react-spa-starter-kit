            ...
            <div className="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
                <header className="mb-6 w-full max-w-4xl">
                    ...
                    >
                        <Link
                            to="/login"
                            className="rounded-sm border border-transparent px-4 py-1.5 text-[#1b1b18] hover:border-[#1915014a] dark:text-[#EDEDEC] dark:hover:border-[#3E3E3A]"
                        >
                            Log in
                        </Link>
                        <Link
                            to="/register"
                            className="rounded-sm border border-[#1915014a] px-4 py-1.5 text-[#1b1b18] dark:border-[#3E3E3A] dark:text-[#EDEDEC]"
                        >
                            Register
                        </Link>
                    </nav>
